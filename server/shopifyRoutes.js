...
// server/shopifyRoutes.js
// Shopify API Vegpontok es Muveletek Modul

async function handleShopifyRoute(req, res, pathname, parsedUrl, ctx) {
  const {
    ordersCache,
...
module.exports = { handleShopifyRoute };
