...
- **PannonXP Számlázási és exportőri beállítások visszavonása**: A felhasználó kérésére teljesen visszaállítottuk a PannonXP CSV-generátor működését a korábbi állapotra (visszaálltak a számlázási oszlopok alapértelmezett értékei, és kivettük a pontosvessző/sortörés eltávolítási szabályokat).
- **Cache-Busting és verziókezelés**: Megemeltük az érintett fájlok importálási cache verzióit `v191`-re a böngészők frissítésének kikényszerítéséhez.
